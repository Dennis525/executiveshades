...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="First In Fashion Shades is the leading Business Offering Best Car Shade Nets and Installation at affordable price. Besides ot also offers tents services"
    />
    <!-- icon -->
    <link rel="icon" href="assets/images/20.jpg" type="image/x-icon" />
    <title>First In Fashion Shades - Kenya | About Us Page</title>
    <!-- google fonts -->
    <link
      href="//fonts.googleapis.com/css2?family=Hind+Siliguri:wght@400;600;700&display=swap"
      rel="stylesheet"
    />
    <!-- Template CSS -->
  ...
  <body>
        ...
        <div class="container">
          <div class="w3breadcrumb-gids">
            <div class="w3breadcrumb-left text-left">
              <h2 class="inner-w3-title mt-sm-5 mt-4">About Us</h2>
            </div>
            <div class="w3breadcrumb-right">
              <ul class="breadcrumbs-custom-path">
                <li><a href="index.php">Home</a></li>
                <li class="active">
                  <span class="fas fa-angle-double-right mx-2"></span> About Us
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mt-lg-0 mt-5">
            <div class="w3l-abouthny-info">
              ...
              <h3 class="title-w3l">
                We are experts in making shades and tents for our clients
              </h3>
              <p class="mt-4">
                We have experience in offering Fabrication and installation of car shades,
                making party tent, installation of carpet grass, selling tent Materials
                and repair of tents.
              </p>

              <ul class="w3l-right-book w3l-right-book-grid mt-md-5 mt-4">
                <li><span class="fas fa-check"></span> Fabrication and installation of car shades</li>
                <li><span class="fas fa-check"></span> Making party tent</li>
                <li><span class="fas fa-check"></span> Installation of carpet grass</li>
                <li><span class="fas fa-check"></span> Selling Tent Materials</li>
                <li>
                  <span class="fas fa-check"></span> Tents repair
                </li>
                <li><span class="fas fa-check"></span> Pargolla</li>
                <li><span class="fas fa-check"></span> Free site visit</li>
              </ul>
              <a href="services.php" class="btn btn-style btn-primary mt-4"
      ...
      <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
          <div class="col-lg-6 mb-lg-0 mb-5 pe-lg-5">
            ...
            <h3 class="title-w3l">The Core Company Values Of Our main Goal</h3>
            <p class="mt-md-4 mt-3">
              Lorem ipsum viverra feugiat. Pellen tesque libero ut justo,
              ultrices in ligula. Semper at. Lorem ipsum dolor sit amet elit.
              Non quae, fugiat nihil ad. Lorem ipsum dolor sit amet init.
            </p>
          </div>
          <div class="col-lg-6 align-self pe-lg-4">
            <div class="progress-info info1">
              <h6 class="progress-tittle">
                Modern Technology <span class="">70%</span>
              </h6>
              <div class="progress">
                <div
            ...
            <div class="progress-info info2">
              <h6 class="progress-tittle">
                Tax Solution Area<span class="">80%</span>
              </h6>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped"
            ...
            <div class="progress-info info3">
              <h6 class="progress-tittle">
                Quick Support <span class="">90%</span>
              </h6>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped"
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    ...
                    inventore veritatis et quasi architecto beat vitaedicta sunt
                    explicabo.
                  </div>
                </div>
              </div>
    ...
    <footer class="w3l-footer9">
      <section class="footer-inner-main py-5">
            ...
            <div class="row footer-hny-grids sub-columns">
              <div class="col-lg-3 sub-one-left">
                ...
                <div class="columns-2 mt-4 pt-lg-2">
                  <ul class="social">
                    <li>
                      <a href="https://www.facebook.com/profile.php?id=100081861385256&mibextid=ZbWKwL"
                        ><span class="fab fa-facebook-f"></span
                      ></a>
                    </li>
                    <li>
                      <a href="https://instagram.com/opiyo2278?igshid=MzNlNGNkZWQ4Mg=="
              ...
              <div class="col-lg-2 sub-two-right">
                ...
                <ul>
                  <li>
                    <a href="#processing"
                      ><i class="fas fa-angle-right"></i> Tent Making</a
                    >
                  </li>
                  <li>
                    <a href="#research"
                      ><i class="fas fa-angle-right"></i> Shade net
                      installation</a
                    >
                  </li>
                  <li>
                    <a href="#metal"
                      ><i class="fas fa-angle-right"></i> Garden Umbrella</a
                    >
                  </li>
                  <li>
                    <a href="#metal"
                      ><i class="fas fa-angle-right"></i> Artifical Grass</a
                    >
                  </li>
                </ul>
              </div>
              ...
              <div class="col-lg-3 sub-one-left ps-lg-5">
                ...
                <ul>
                  <li>
                    <a href="tel:+254 700 254065"
                      ><i class="fas fa-angle-right">Phone Number:</i> +254 700
                      254065</a
                    >
                  </li>
                  <li>
                    <a href="mailto:info@executiveshades.co.ke"
                      ><i class="fas fa-angle-right">Email:</i>
          ...
          <div class="below-section mt-5 pt-lg-3">
            <div class="copyright-footer">
              <div class="columns text-left">
                <p>
                  &copy; 2023 | Executive Shades & Tents | Design by
        ...
        href="whatsapp://send?phone=254700254065"
        target="_blank"
      >
